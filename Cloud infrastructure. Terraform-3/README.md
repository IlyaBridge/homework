# Домашнее задание к занятию "`Управляющие конструкции в коде Terraform`" - `Казначеев Илья`

https://github.com/netology-code/ter-homeworks/blob/main/03/hw-03.md#задание-1
